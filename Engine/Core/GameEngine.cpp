...
namespace AronEngine
{
    ...
    bool GameEngine::InitializeSystems(void* windowHandle)
    {
        ...
        resourceManager = std::shared_ptr<ResourceManager>(&ResourceManager::GetInstance(), [](ResourceManager*){});
        
        sceneManager = std::shared_ptr<SceneManager>(&SceneManager::GetInstance(), [](SceneManager*){});
        ...
        // Initialize renderer (would need actual D2D context)
