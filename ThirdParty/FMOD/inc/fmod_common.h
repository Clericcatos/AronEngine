// Temporary FMOD common header for compilation
#pragma once
...
// FMOD Version
#define FMOD_VERSION 0x00020212
...
#define F_API extern "C"

// Debug callback
typedef FMOD_RESULT (F_CALL *FMOD_DEBUG_CALLBACK)(unsigned int flags, const char *file, int line, const char *func, const char *message);
